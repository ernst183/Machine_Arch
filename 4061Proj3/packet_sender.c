...
int main(int argc, char **argv) {
  ...
  printf("Receiving PID\n");
  
  msgrcv(msqid, &pqm, sizeof(int) + 1, QUEUE_MSG_TYPE, 0);
  receiver_pid = pqm.pid;
  printf("Got pid : %d\n", receiver_pid);
   ...
   */
  act.sa_sigaction = (void *)packet_sender;
